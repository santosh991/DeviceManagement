package com.smart.school.devicemanagement.common.utilities;
...
public class PageListUtil {
     ...
     * @return
     */
    public static <T> PageList<T> getPageList(int totalCount, int pageIndex, List<T> items, int pageSize) {
        return new PageList<T>(totalCount, pageIndex, pageSize, items);
    }
}
