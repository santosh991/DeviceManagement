                     ...
                     <form:form modelAttribute="contentModel" class="form-horizontal" method="POST">
                        <div class="form-body">
                           ...
                           <div class="form-group">
                              ...
                              <div class="col-md-10">
                                 <form:textarea path="childrenName" class="form-control" placeholder="孩子姓名"/><br/>
                           ...
                           <div class="form-group">
                              ...
                              <div class="col-md-10">
                                 <form:textarea path="relation" class="form-control" placeholder="长幼关系"/><br/>
                           ...
                           <div class="form-group">
                              ...
                              <div class="col-md-10">
                                 <form:textarea path="phone1" class="form-control" placeholder="联系电话"/><br/>
                           ...
                           <div class="form-group">
                              ...
                              <div class="col-md-10">
                                 <form:textarea path="phone2" class="form-control" placeholder="备用联系电话"/><br/>
