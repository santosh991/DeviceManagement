...
<body class="page-header-fixed">
							...
							<div class="row">
							   ...
							   <div class="col-md-9">
								  <div class="form-group">
									 <label class="control-label col-md-3">搜索关键字</label>
									 <div class="col-md-6">
										<form:input path="strName" class="form-control placeholder-no-fix" autocomplete="off" placeholder="联系人姓名或儿童姓名"/>
									 </div>
									 <div class="col-md-3">
                  ...
                  <div class="portlet-body">
                     ...
                     <div class="dataTables_wrapper form-inline" role="grid">
	                     ...
	                     <c:import url = "../shared/paging.jsp">
	        				...
	        				<c:param name="urlAddress" value="/customInfo/list"/>
	       				 </c:import>
       				 </div>
                  </div>
               </div>
   ...
   <script type="text/javascript">
         ...
         $(".table-toolbar").toolbarLite({
             items: [
                 { link: true, display: "新建", css: "icon-plus", showIcon: true, url: "<%=UrlHelper.resolveWithReturnUrl("/customInfo/add", request.getAttribute("requestUrl"), request.getAttribute("requestQuery"), pageContext)%>" },
                 { splitter: true }, 
                 { link: true, display: "编辑", css: "icon-edit", showIcon: true, url: "<%=UrlHelper.resolveWithReturnUrl("/customInfo/edit/{0}", request.getAttribute("requestUrl"), request.getAttribute("requestQuery"), pageContext)%>", 
                   	selector: "#data-table .checkboxes", mustSelect: "请先选择数据！", singleSelect: "该操作只支持单选！"},
                 { splitter: true }, 
                 { link: true, display: "删除", css: "icon-trash", showIcon: true, url: "<%=UrlHelper.resolveWithReturnUrl("/customInfo/delete/{0}", request.getAttribute("requestUrl"), request.getAttribute("requestQuery"), pageContext)%>", 
