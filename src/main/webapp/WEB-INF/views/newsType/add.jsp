            ...
            <div class="col-md-12">
               ...
               <div class="portlet ">
                  <div class="portlet-title">
                     <div class="caption"><i class="icon-edit"></i>公告类型</div>
                  </div>
                     ...
                     <form:form modelAttribute="contentModel" class="form-horizontal" method="POST">
                        <div class="form-body">
                           <div class="form-group">
                              ...
                              <div class="col-md-10">
                                 <form:input path="strName" class="form-control" placeholder="类型名称"/><br/>
                                 <form:errors path="strName" class="field-has-error"></form:errors>
                              </div>
                           </div>      
                           <div class="form-group">
                              <label  class="col-md-2 control-label">优先级别</label>
                              <div class="col-md-10">
                                 <form:input path="level" class="form-control" placeholder="优先级别"/><br/>
